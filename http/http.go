...
import (
	...
	categoryDecode "github.com/phucledien/example-go/http/decode/json/category"
	userDecode "github.com/phucledien/example-go/http/decode/json/user"
)
